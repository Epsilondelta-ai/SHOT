...
describe("POST /api/games/:id/start", () => {
  it("rejects start when a non-host player is not ready", async () => {
    mockGetSerializedRoomPlayers.mockResolvedValueOnce([
      { id: "p1", userId: "u1", name: "P1", avatarSrc: null, type: "human", assistantId: null, assistantName: null, llmModelId: null, modelName: null, language: null, ready: false, ownerName: null , provider: null, isOperator: false },
      { id: "p2", userId: "u2", name: "P2", avatarSrc: null, type: "human", assistantId: null, assistantName: null, llmModelId: null, modelName: null, language: null, ready: true, ownerName: null , provider: null, isOperator: false },
      { id: "p3", userId: "u3", name: "P3", avatarSrc: null, type: "human", assistantId: null, assistantName: null, llmModelId: null, modelName: null, language: null, ready: false, ownerName: null , provider: null, isOperator: false },
      { id: "p4", userId: "u4", name: "P4", avatarSrc: null, type: "human", assistantId: null, assistantName: null, llmModelId: null, modelName: null, language: null, ready: true, ownerName: null , provider: null, isOperator: false },
      { id: "p5", userId: "u5", name: "P5", avatarSrc: null, type: "human", assistantId: null, assistantName: null, llmModelId: null, modelName: null, language: null, ready: true, ownerName: null , provider: null, isOperator: false },
    ]);
  ...
  it("starts the game when readiness requirements are satisfied", async () => {
    mockGetSerializedRoomPlayers.mockResolvedValueOnce([
      { id: "p1", userId: "u1", name: "P1", avatarSrc: null, type: "human", assistantId: null, assistantName: null, llmModelId: null, modelName: null, language: null, ready: false, ownerName: null , provider: null, isOperator: false },
      { id: "p2", userId: "u2", name: "P2", avatarSrc: null, type: "human", assistantId: null, assistantName: null, llmModelId: null, modelName: null, language: null, ready: true, ownerName: null , provider: null, isOperator: false },
      { id: "p3", userId: "u3", name: "P3", avatarSrc: null, type: "human", assistantId: null, assistantName: null, llmModelId: null, modelName: null, language: null, ready: true, ownerName: null , provider: null, isOperator: false },
      { id: "p4", userId: "u4", name: "P4", avatarSrc: null, type: "human", assistantId: null, assistantName: null, llmModelId: null, modelName: null, language: null, ready: true, ownerName: null , provider: null, isOperator: false },
      { id: "p5", userId: "u5", name: "P5", avatarSrc: null, type: "human", assistantId: null, assistantName: null, llmModelId: null, modelName: null, language: null, ready: true, ownerName: null , provider: null, isOperator: false },
    ]);
